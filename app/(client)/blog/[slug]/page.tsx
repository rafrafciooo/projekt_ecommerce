	...
	return (
		<div>
			<div className='border border-lightColor p-5 rounded-md'>
				<Title className='text-base'>Kategorie</Title>
				<div className='space-y-2 mt-2'>
					{categories?.map(
						({ blogcategories }: CategoryItem, index: number) => (
							<div
								key={index}
								className='text-lightColor flex items-center justify-between text-sm font-medium'
							>
								<p>{blogcategories?.[0]?.title ?? "Brak tytułu"}</p>
			...
			<div className='border border-lightColor p-5 rounded-md mt-10'>
				<Title className='text-base'>Ostatnie wpisy</Title>
